    ...
    return (
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="navbar-dark ms-auto">
            ...
            <Nav.Link href="#link"><img style={{padding: 5}} src="icons/person-circle.svg"/>Patient Login</Nav.Link>
            <Nav.Link href="#home"><img style={{padding: 5}} src="icons/telephone.svg"/>Call 601-898-0911</Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
